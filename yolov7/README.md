...
```shell
python export.windows --weights yolov7-tiny.pt --grid --end2end --simplify \
...
python export.windows --weights ./yolov7-tiny.pt --grid --end2end --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640 640
git clone https://github.com/Linaom1214/tensorrt-python.git
python ./tensorrt-python/export.windows -o yolov7-tiny.onnx -e yolov7-tiny-nms.trt -p fp16
```
...
```shell
wget https://github.com/WongKinYiu/yolov7/releases/download/v0.1/yolov7-tiny.pt
python export.windows --weights yolov7-tiny.pt --grid --include-nms
git clone https://github.com/Linaom1214/tensorrt-python.git
python ./tensorrt-python/export.windows -o yolov7-tiny.onnx -e yolov7-tiny-nms.trt -p fp16
